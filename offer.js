    ...
    function renderTabPreview(p){
      ...
      return '<div style="position:relative;height:calc(100vh - 130px);overflow:hidden">'
        ...
        +'<div style="position:absolute;top:16px;right:16px;display:flex;flex-direction:column;align-items:center;gap:6px;z-index:10">'
          ...
          +'</div>'
          +'<button onclick="currentProjectId=\''+p.id+'\';openOfferFullPreview()" style="background:#333;color:#fff;border:none;border-radius:5px;padding:5px 12px;font-size:10px;font-weight:700;cursor:pointer;white-space:nowrap;margin-bottom:6px">🔍 Åpne tilbud</button>'
          +'<button onclick="currentProjectId=\''+p.id+'\';downloadOfferPDF()" style="background:#34c759;color:#fff;border:none;border-radius:5px;padding:5px 12px;font-size:10px;font-weight:700;cursor:pointer;white-space:nowrap;margin-bottom:6px">⬇️ Last ned PDF</button>'
          +'<button onclick="currentProjectId=\''+p.id+'\';sendOfferNow()" style="background:#2e75b6;color:#fff;border:none;border-radius:5px;padding:5px 12px;font-size:10px;font-weight:700;cursor:pointer;white-space:nowrap">📧 Send tilbud</button>'
        +'</div>'
      +'</div>';
    }
      ...
      el.innerHTML=''
        ...
        +'<div class="card" style="margin:0">'
          ...
          +'<div style="display:flex;flex-direction:column;gap:8px">'
            +'<label style="display:flex;align-items:center;gap:8px;font-size:13px;cursor:pointer;padding:8px 10px;border-radius:10px;border:2px solid '+(os.prisType==='medgaatt'?'var(--blue)':'var(--line)')+';background:'+(os.prisType==='medgaatt'?'#f0f7ff':'#fff')+'">'
            ...
            +'</label>'
            +'<label style="display:flex;align-items:center;gap:8px;font-size:13px;cursor:pointer;padding:8px 10px;border-radius:10px;border:2px solid '+(os.prisType==='fastpris'?'var(--blue)':'var(--line)')+';background:'+(os.prisType==='fastpris'?'#f0f7ff':'#fff')+'">'
            ...
            +'</label>'
            +'<label style="display:flex;align-items:center;gap:8px;font-size:13px;cursor:pointer;padding:8px 10px;border-radius:10px;border:2px solid '+(os.prisType==='begge'?'var(--blue)':'var(--line)')+';background:'+(os.prisType==='begge'?'#f0f7ff':'#fff')+'">'
